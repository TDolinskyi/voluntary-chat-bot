...
import de.bot.db.dao.AuthTokenDao
import de.bot.db.model.AuthToken
...
@Singleton
class AuthTokenService @Inject()(authTokenDAO: AuthTokenDao, clock: Clock)(implicit ec: ExecutionContext) {
   ...
   */
  def create(userID: UUID, expiry: FiniteDuration = 90 minutes) = {
